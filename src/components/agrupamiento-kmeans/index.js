...
const Agrupamientokmeans = (props) => {
                ...
                <Box className={classes.paper1} boxShadow={0} height={750}>
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={6} sm={5} className={classes.grid2}>
                            ...
                            <p className={classes.p}>Se muestra la información de las secuencias genómicas agrupadas con el algoritmo k-means en el gráfico de la izquierda.</p>
